          ...
          <form onSubmit={handleSignIn} className="space-y-3.5 text-xs">
            ...
            <div className="relative my-3">
              ...
              <div className="relative flex justify-center text-[10px] uppercase">
                <span className="bg-white/80 dark:bg-[#0c0e14] px-2 text-slate-400 font-semibold tracking-wider">
                  Or continue with
                </span>
              </div>
            </div>

            {/* Google / Cognito OAuth Button */}
            <button
              type="button"
              onClick={async () => {
                try {
              ...
              className="w-full flex items-center justify-center gap-2.5 rounded-xl border border-black/10 dark:border-white/15 bg-white/80 dark:bg-white/[0.04] py-2.5 font-medium text-slate-800 dark:text-slate-200 hover:bg-black/[0.03] dark:hover:bg-white/[0.08] transition-colors shadow-sm"
            >
